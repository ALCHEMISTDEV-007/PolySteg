...
class PDFFileMetadata:
    ...
    def decryptfile(input_file_path,output_file_path,metadata_key_name):
        with open(input_file_path, 'rb') as file:
            ...
            for item in metadata:
                if item == metadata_key_name:
                    foundflag=True
                    savefile(binary_string=metadata[item],output_file=output_file_path)
            if foundflag == False:
                print("That Metadata Key name was not found")